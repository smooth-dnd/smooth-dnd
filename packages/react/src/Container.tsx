...
import { smoothDnD as container, ContainerOptions, SmoothDnD, dropHandlers } from '@smooth-dnd/core'

container.dropHandler = dropHandlers.jsxDropHandler().handler
...
class Container extends Component<ContainerProps> {
  ...
  isObjectTypePropsChanged(prevProps: ContainerProps) {
    const { render, style, ...containerOptions } = this.props
